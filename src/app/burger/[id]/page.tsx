...
export default async function BurgerPage({ params }: BurgerPageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto bg-[#f4e4bc] backdrop-blur-sm rounded-lg shadow-lg overflow-hidden relative border-8 border-[#8b4513]">
        {/* Decorative corner elements */}
        <div className="absolute top-0 left-0 w-16 h-16 bg-[#8b4513] transform -rotate-45 -translate-x-8 -translate-y-8"></div>
        <div className="absolute top-0 right-0 w-16 h-16 bg-[#8b4513] transform rotate-45 translate-x-8 -translate-y-8"></div>
        <div className="absolute bottom-0 left-0 w-16 h-16 bg-[#8b4513] transform rotate-45 -translate-x-8 translate-y-8"></div>
        <div className="absolute bottom-0 right-0 w-16 h-16 bg-[#8b4513] transform -rotate-45 translate-x-8 translate-y-8"></div>

        {/* WANTED text */}
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
          <h2 className="text-6xl font-bold text-[#8b4513] tracking-wider font-serif">
            WANTED
          </h2>
        </div>
        ...
        <div className="relative h-[320px] lg:h-[480px] w-full">
          <Image
            ...
            fill
            className="object-cover hover:sepia-0 transition-all duration-300"
            priority
          />
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-0">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-xl text-[#8b4513] mb-2 italic">
                Last seen at: {burger.restaurant}
              </p>
